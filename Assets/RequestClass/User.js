                ...
                this.db.query('SELECT name FROM media WHERE name =?', [data.mediaName])
                    .then((result) => {
                        if (result[0] !== undefined) {
                            ...
                            this.db.query('SELECT id FROM category WHERE name = ?', [data.category])
                                .then((idCategory) => {
                                                    ...
                                                    .then((param) => {
                                                        ...
                                                        this.db.query('INSERT INTO user_role (id_role, id_user) VALUES (?,?) ', [data.role, idUser.insertId])
                                                            .then(() => {
                                                                ...
                                                                console.log(idCategory[0].id)
                                                                console.log(media.insertId)

                                                                this.db.query('INSERT INTO category_media (id_category, id_media) VALUES (?,?)', [idCategory[0].id, media.insertId])
                                                                    .then(() => {
                                                                    })
                                                                    .catch((err) => next(err))
                                                            })
